            ...
            <div class="newsletter-card">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 newsletter-content">
                        <h3>Never miss a shipment update!</h3>
                        <p>Subscribe for smart logistics tips, real-time updates, and exclusive offers to simplify your shipping experience.</p>
                    </div>
    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6 pe-md-5">
                <a href="index.php" class="footer-logo">
                    <img src="{{ asset('/website_images/logo-white.png') }}" class="img-fluid" style="max-width: 240px;">
                </a>
        ...
        <div class="footer-bottom">
            ...
            <ul class="legal-links">
                <li class="copyright">Designed & Developed By <a href="https://www.adomantra.com/"> Adomantra Digital India Pvt Ltd</a></li>
            </ul>
        </div>
    </div>
</footer>
