    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="content pb-0">
                ...
                <!-- Subscribers Content Table -->
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Subscriber List</h5>
                                <p class="card-text">View all newsletter subscribers who have subscribed from the website footer</p>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            @forelse($subscribers as $subscriber)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ $subscriber->created_at ? $subscriber->created_at->format('d M Y, h:i A') : 'N/A' }}
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>
                                                    <td colspan="3" class="text-center py-4">
                                                        <p class="text-muted">No subscribers yet. Subscribe from the website footer to see them here.</p>
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
