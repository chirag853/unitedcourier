...
<head>
    ...
    <title>Admin Panel | UWC - FAQ Queries</title>
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="content pb-0">
                ...
                <!-- FAQ Queries Content Table -->
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Query List</h5>
                                <p class="card-text">View all support queries submitted from the FAQ / Get Support section</p>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="faqQueriesTable">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Full Name</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $query->phone }}</td>
                                                <td class="message-cell">{{ $query->message }}</td>
                                                <td>
                                                    @if($query->page_name)
                                                        <span class="badge bg-light text-dark">{{ $query->page_name }}</span>
                                                    @else
                                                        <span class="text-muted">—</span>
                                                    @endif
                                                </td>
                                                <td>
                                                    <span class="badge-query">
                                            ...
                                            <tr>
                                                <td colspan="7" class="text-center py-4">
                                                    <p class="text-muted">No queries found. Submit a query from the Get Support section to see them here.</p>
                                                </td>
                                            </tr>
                                            @endforelse
                                        </tbody>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#faqQueriesTable').DataTable({
                order: [[0, 'desc']], // Sort by # descending (newest first)
                pageLength: 25,
                language: {
