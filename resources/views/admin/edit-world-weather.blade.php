...
<body>
    ...
    document.getElementById('worldWeatherForm').addEventListener('submit', function(e) {
        ...
        let url = worldWeatherId ? `${BASE_URL}/admin/update-world-weather/${worldWeatherId}` : `${BASE_URL}/admin/store-world-weather`;
        ...
        fetch(url, {
            ...
            .then(data => {
                if (data.success) {
                    showAlert(data.message, 'success', function () { window.location.href = '{{ route("admin.change-world-weather") }}'; });
                } else {
