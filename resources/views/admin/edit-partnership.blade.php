...
<body>
    ...
    document.getElementById('partnershipForm').addEventListener('submit', function(e) {
        ...
        let url = partnerId ? `${BASE_URL}/admin/update-partnership/${partnerId}` : `${BASE_URL}/admin/store-partnership`;
        ...
        fetch(url, {
            ...
            .then(data => {
                if (data.success) {
                    showAlert(data.message, 'success', function () { window.location.href = '{{ route("admin.change-partnership") }}'; });
                } else {
