            ...
            <ul>
                ...
                <li>
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class="{{ request()->is('admin/companies') || request()->is('admin/dispute-orders') || request()->is('admin/cancel-orders') ? 'active subdrop' : '' }}">
                                <i class="ti ti-dashboard"></i><span>Manage Orders</span><span class="menu-arrow"></span>
                            </a>
                            <ul>
                                <li class="submenu submenu-two">
                                    <a href="javascript:void(0);"
                                        class="{{ request()->is('admin/companies') || request()->is('admin/dispute-orders') || request()->is('admin/cancel-orders') ? 'active' : '' }}">Orders<span
                                            class="menu-arrow inside-submenu"></span></a>
                                    <ul>
                                        <li><a href="{{ url('/admin/companies') }}"
                                                class="{{ request()->is('admin/companies') ? 'active' : '' }}">View All Order</a></li>
                                        <li><a href="{{ route('admin.dispute-orders') }}"
                                                class="{{ request()->is('admin/dispute-orders') ? 'active' : '' }}">Dispute Orders</a></li>
                                        <li><a href="{{ route('admin.cancel-orders') }}"
                                                class="{{ request()->is('admin/cancel-orders') ? 'active' : '' }}">Cancel Orders</a></li>
                                    </ul>
                                </li>
                                <!-- <li class="submenu">
