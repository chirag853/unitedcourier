            ...
            <ul>
                ...
                <li>
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class="{{ request()->is('admin/companies') || request()->is('admin/dispute-orders') ? 'active subdrop' : '' }}">
                                <i class="ti ti-dashboard"></i><span>Manage Orders</span><span class="menu-arrow"></span>
                            </a>
                            <ul>
                                <li class="submenu submenu-two">
                                    <a href="javascript:void(0);"
                                        class="{{ request()->is('admin/companies') || request()->is('admin/dispute-orders') ? 'active' : '' }}">Orders<span
                                            class="menu-arrow inside-submenu"></span></a>
                                    <ul>
