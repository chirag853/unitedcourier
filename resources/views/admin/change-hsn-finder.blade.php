...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="content pb-0">
                ...
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">HSN Finder Page</h4>
                    </div>
                ...
                <!-- HSN Finder Page Content Table -->
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">HSN Finder Page Content Management</h5>
                                <p class="card-text">View and Edit all HSN Finder page content sections</p>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="hsnFinderContentTable">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Section Type</th>
                                        ...
                                        <tbody>
                                            @forelse($hsnFinderContent as $content)
                                                <tr>
                                                    <td>{{ $content->id }}</td>
                                                    <td>
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="7" class="text-center py-4">
                                                        <p class="text-muted">No HSN Finder content found. The page is empty.</p>
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit HSN Finder Content</h5>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#hsnFinderContentTable').DataTable({
        ...
        function editContent(id, sectionType, title, subtitle, description, badgeText, buttonText, iconClass, tag, label, placeholder, link, displayOrder, status) {
            ...
            // Set form action
            $('#editForm').attr('action', '{{ url("/admin/update-hsn-finder-content") }}/' + id);
        }
        ...
        $('#confirmDeleteBtn').on('click', function() {
            if (deleteId) {
                $.ajax({
                    url: '{{ url("/admin/delete-hsn-finder-content") }}/' + deleteId,
                    type: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
