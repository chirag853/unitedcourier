...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="content pb-0">
                ...
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Shipping Rate Calculator Page</h4>
                    </div>
                ...
                <!-- Shipping Rate Calculator Page Content Table -->
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Shipping Rate Calculator Page Content Management</h5>
                                <p class="card-text">View and Edit all Shipping Rate Calculator page content sections</p>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="shippingRateContentTable">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Section Type</th>
                                        ...
                                        <tbody>
                                            @forelse($shippingRateContent as $content)
                                                <tr>
                                                    <td>{{ $content->id }}</td>
                                                    <td>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#shippingRateContentTable').DataTable({
        ...
        $('#confirmDeleteBtn').on('click', function() {
            if (deleteId) {
                $.ajax({
                    url: '{{ url("/admin/delete-shipping-rate-calculator-content") }}/' + deleteId,
                    type: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
