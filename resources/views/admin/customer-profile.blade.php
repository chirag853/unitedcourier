...
<head>
    ...
    <style>
        ...
        /* Match the shared password-field treatment inside the reset modal only. */
        #resetPasswordModal .reset-password-input-group {
            position: relative;
        }
        #resetPasswordModal .reset-password-input-group input {
            padding-left: 42px;
            padding-right: 48px;
            -webkit-appearance: none;
            appearance: none;
        }
        #resetPasswordModal .reset-password-input-group input::-ms-reveal,
        #resetPasswordModal .reset-password-input-group input::-ms-clear,
        #resetPasswordModal .reset-password-input-group input::-webkit-credentials-auto-fill-button {
            display: none;
        }
        #resetPasswordModal .reset-password-input-group > .reset-password-lock {
            position: absolute;
            left: 16px;
            top: 50%;
        ...
        #resetPasswordModal .reset-password-input-group > .password-toggle {
            position: absolute;
            right: 10px;
            top: 50%;
            transform: translateY(-50%);
        ...
        #resetPasswordModal .reset-password-input-group > .password-toggle:hover,
        #resetPasswordModal .reset-password-input-group > .password-toggle:focus {
            color: #2563eb;
            background: transparent;
            box-shadow: none;
            outline: none;
        }
        #resetPasswordModal .reset-password-input-group > .password-toggle i {
            pointer-events: none;
        }
    </style>
</head>
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                        <div>
                            ...
                            <p class="text-muted mb-1">
                                <i class="ti ti-hash me-1"></i>Customer Code: <strong>{{ $customer->customer_code ?? '—' }}</strong>
                            </p>
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            <button type="button" class="stepper-nav-btn kyc-preview-btn btn btn-success" data-bs-toggle="modal" data-bs-target="#kycPreviewModal"><i class="ti ti-eye"></i> Preview KYC</button>
                            ...
                            <!-- <button type="button" class="stepper-nav-btn kyc-preview-btn" data-bs-toggle="modal" data-bs-target="#kycPreviewModal"><i class="ti ti-eye"></i> Preview KYC</button> -->
                            @endif
                        </div>
                    </div>
                </div>
                        ...
                        <div class="kyc-card">
                            ...
                            <div id="step6-content" class="step-content">
                                ...
                                <div class="document-wrapper">
                                    ...
                                    <p>This Merchant Agreement <strong>("Agreement")</strong> is between you company/individual/firm/partnership/body corporate), together with any company or other business entity you are representing, if any (hereinafter collectively referred as "Merchant" or "you" or "User"); and <strong>United Worldwide Couriers Pvt Ltd</strong> , a company registered under the Companies Act, 1956, having its registered office at Building A-219, First Floor, Road No. 5, Mahipalpur Extension, New Delhi 110037, offering 'Logistics Management Services', under the name 'United Worldwide Couriers Pvt Ltd' (hereinafter referred to as "United Worldwide Couriers " or "we" or "Company", and together with the User referred jointly as the "Parties" and individually as a "Party"). 
...
<p>This Annexure D is intended only to govern documentation, evidence, and claim-processing requirements. Compensation limits, exclusions, RTO treatment, and service-specific claim outcomes shall be governed by the Merchant Agreement and the applicable claim policy.</p>
    ...
    <!-- KYC Summary Preview Modal -->
    <div class="modal fade" id="kycPreviewModal" tabindex="-1" aria-labelledby="kycPreviewTitle" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="kycPreviewTitle"><i class="ti ti-file-description me-2"></i>KYC Details Preview</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    @php
                        $previewSources = array_filter([$kyc, $alt]);
                        $previewValue = static function ($field) use ($previewSources) {
                ...
                <div class="modal-footer">
                    <a class="btn btn-primary" href="{{ route('admin.customer.kyc-documents.download', $customer->id) }}"><i class="ti ti-download me-1"></i>Download All Documents</a>
                ...
                <form id="resetPasswordForm" method="POST" action="">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group reset-password-input-group">
                                <input type="password" class="form-control" name="password" id="resetPassword" required minlength="6">
                                <i class="ti ti-lock reset-password-lock" aria-hidden="true"></i>
                                <button type="button" class="password-toggle" aria-label="Show password"><i class="ti ti-eye"></i></button>
                            </div>
    ...
    <script>
        ...
        if (kycStepperCard) {
            ...
            kycStepperCard.querySelectorAll('.stepper-nav-btn[data-dir]').forEach(function(btn) {
