...
<body>
    ...
    document.getElementById('editForm').addEventListener('submit', function(e) {
        ...
        let url = id ? `${BASE_URL}/admin/update-express-air-freight-solutions-content/${id}` : `${BASE_URL}/admin/store-express-air-freight-solutions-content`;
    ...
    function deleteContent(id) {
        if (confirm('Are you sure you want to delete this content?')) {
            fetch(`${BASE_URL}/admin/delete-express-air-freight-solutions-content/${id}`, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
                }
