...
<head>
    ...
    <meta name="description" content="Manage refund and cancellation policy page content for leadCRM website.">
    <meta name="keywords" content="refund policy, cancellation policy, admin, CRM, content management">
...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="content pb-0">
                ...
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Change Refund & Cancellation Policy</h4>
                    </div>
                ...
                <!-- Refund & Cancellation Policy Page Content Table -->
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Refund & Cancellation Policy Page Content Management</h5>
                                <p class="card-text">View and Edit all Refund & Cancellation Policy page content sections</p>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="refundPolicyContentTable">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Section Key</th>
                                        ...
                                        <tbody>
                                            @forelse($refundContent as $content)
                                                <tr>
                                                    <td>{{ $content->id }}</td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="table-actions">
                                                            <button type="button" class="btn btn-sm btn-primary action-btn btn-edit-rc" data-bs-toggle="modal" data-bs-target="#editModal"
                                                                data-id="{{ $content->id }}"
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="6" class="text-center py-4">
                                                        <p class="text-muted">No refund and cancellation policy content found.</p>
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="editModalLabel">Edit Refund & Cancellation Policy Content</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" id="pageMetaFields" style="display:none;">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="footerHeading" name="footer_heading" placeholder="Questions about our Refund Policy?">
                                </div>
                                <div class="mb-3">
    ...
    $(document).ready( function () {
        $('#refundPolicyContentTable').DataTable();
    });
    ...
    document.addEventListener('click', function(e) {
        const btn = e.target.closest('.btn-edit-rc');
        if (!btn) return;
    ...
    document.getElementById('editForm').addEventListener('submit', function(e) {
        ...
        fetch(`${BASE_URL}/admin/update-refund-and-cancellation-policy-content/${id}`, {
            method: 'POST',
            body: formData,
            headers: {
    ...
    function deleteContent(id) {
        if (confirm('Are you sure you want to delete this content?')) {
            fetch(`${BASE_URL}/admin/delete-refund-and-cancellation-policy-content/${id}`, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
                }
