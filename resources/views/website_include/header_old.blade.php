    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center gap-2" href="index.php">
                <img src="{{ asset('public/website_images/logo-new.png') }}" class="img-fluid" style="max-width: 215px;">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                            ...
                            <div class="menu-col-left">
                                ...
                                <a href="#" class="menu-item">
                                    ...
                                    <div class="menu-info">
                                        ...
                                        <p>United Courier ensures seamless pickup from your doorstep and delivery
                                            directly to your international customer.</p>
                                    </div>
                                </a>
                                <a href="#" class="menu-item">
                                    <div class="menu-icon-box" style="background: #5f91ff1f; color: #2563eb;">
                                ...
                                <a href="#" class="menu-item">
                                    ...
                                    <div class="menu-info">
                                        ...
                                        <p>Get your export documentation right the first time. Our experts guide you
                                            through every requirement.</p>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="share-docs-bar">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0 fw-bold" style="font-size: 18px; color: #1a1a1a;">₹7,00,000
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <li class="nav-item"><a class="nav-link" href="#">Platform</a></li>
                ...
                <div class="d-flex flex-column flex-lg-row align-items-center gap-3">
                    <a href="login.php" class="text-decoration-none fw-bold text-dark"
                        style="font-size: 15px;">Login</a>
                    <a href="register.php" class="btn-signup-main w-100 w-lg-auto text-decoration-none">Sign Up for
                        Free</a>
                </div>
            </div>
        </div>
