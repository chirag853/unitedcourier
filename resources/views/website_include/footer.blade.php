        ...
        <div class="newsletter-card">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 newsletter-content">
                    ...
                    <p>Get the latest shipping information, delivery updates, industry trends, and exclusive service
                        benefits straight to your inbox.</p>
                </div>
                ...
                <div class="col-lg-5 d-none">
                    <form id="subscribeForm">
                        ...
                        <div id="subscribeMessage" class="subscribe-message"
                            style="margin-top: 8px; font-size: 14px; display: none;"></div>
                    </form>
                </div>
            </div>
        </div>
        ...
        <svg width="100%" height="100%" viewBox="0 0 1200 400" preserveAspectRatio="none">
            ...
            <g class="airplane-icon">
                <path
                    ...
                    transform="scale(2) rotate(90 12 12)" />
            </g>
        </svg>
    </div>
