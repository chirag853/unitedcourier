...
<head>
    ...
    @media (max-width: 640px) {
      ...
      .document-wrapper { padding: 1.8rem 1.25rem; border-radius: 20px; }
    }
                ...
                @if(auth()->guard('customer')->check())
                    ...
                    @if(!$kycExists)
                        ...
                        <div class="stepper-container">
                            ...
                            <div class="stepper-wrapper">
                                ...
                                <div class="step-item" id="step4-indicator">
                                    <div class="step-bar"><div class="step-bar-fill"></div></div>
                                    <div class="step-label">4. Terms of Agreement</div>
                                </div>
                                <div class="step-item" id="step5-indicator">
                                    <div class="step-bar"><div class="step-bar-fill"></div></div>
                                    <div class="step-label">5. CSB V Ramp UP</div>
                                </div>
                            </div>
                            ...
                            <div class="kyc-card">
                                    ...
                                    <div class="row g-3 mb-3">
                                        <div class="col-md-8">
                                            ...
                                            <div class="input-group-custom">
                                                <input type="text" class="form-control input-custom" placeholder="22AAAAA0000A1Z5" id="gstInput" maxlength="15" style="text-transform: uppercase;">
                                                <i class="fas fa-file-invoice"></i>
                                            </div>
                                            <small class="text-muted d-block mt-1">Format: 2-digit state code + 10-char PAN + entity code + Z + checksum (15 chars)</small>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label-custom d-none d-md-block">&nbsp;</label>
                                            <button class="btn btn-primary-custom" style="padding: 14px;" id="verifyGstBtn" onclick="verifyGst()">Verify GST</button>
                                        </div>
                                    </div>
                                    ...
                                    <div id="otpSection" style="display: none;">
                                        <div class="row g-3 mb-3">
                                            <div class="col-md-8">
                                                ...
                                                <p class="text-muted small mb-2">GST verified. Send an OTP to your registered mobile/email to continue.</p>
                                            </div>
                                            <div class="col-md-4">
                                                <button class="btn btn-primary-custom" style="padding: 14px;" id="sendOtpBtn" onclick="sendOTP()">Send OTP</button>
                                            </div>
                                        </div>
                                        ...
                                        <div id="otpContainer" style="display: none;">
                                            ...
                                            <div class="input-group-custom">
                                                <input type="text" class="form-control input-custom" placeholder="******" maxlength="6" id="otpInput">
                                                <i class="fas fa-key"></i>
                                            </div>
                                            <button class="btn btn-primary-custom mt-2" onclick="nextStep(2)">Verify & Continue</button>
                                        </div>
                                    </div>
                                ...
                                <div id="step2-content" class="step-content">
                                    ...
                                    <div class="row g-3 mb-4">
                                        <div class="col-md-8">
                                            ...
                                            <div class="input-group-custom">
                                                <input type="text" class="form-control input-custom" placeholder="XXXX XXXX XXXX" id="aadharInput" maxlength="14" inputmode="numeric">
                                                <i class="fas fa-id-card"></i>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label-custom d-none d-md-block">&nbsp;</label>
                                            <button class="btn btn-primary-custom" style="padding: 14px;" id="verifyAadharBtn" onclick="verifyAadhar()">Verify Aadhar</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex flex-column flex-md-row justify-content-between pt-3 gap-3">
                                        ...
                                        <button class="btn btn-primary-custom" style="width: auto; padding-left: 60px; padding-right: 60px;" id="aadharContinueBtn" onclick="nextStep(3)">Continue</button>
                                    </div>
                                </div>
                                ...
                                <div id="step3-content" class="step-content">
                                    ...
                                    <div class="d-flex flex-column flex-md-row justify-content-between pt-3 gap-3">
                                        <button class="btn btn-outline-custom flex-md-shrink-1" style="width: auto; padding-left: 40px; padding-right: 40px;" onclick="nextStep(2)">Back</button>
                                        <button class="btn btn-primary-custom" style="width: auto; padding-left: 60px; padding-right: 60px;" onclick="nextStep(4)">Continue</button>
                                    </div>
                                </div>
                                ...
                                <div id="step4-content" class="step-content">
                                    ...
                                    <div class="form-check mb-4 p-0" style="display: flex; align-items: center; gap: 10px;">
                                        <input class="form-check-input" required type="checkbox" id="agreeTerms" style="margin: 0; width: 18px; height: 18px; cursor: pointer;">
                                    ...
                                    <div class="d-flex flex-column flex-md-row justify-content-between gap-3">
                                        <button class="btn btn-outline-custom" style="width: auto; padding-left: 40px; padding-right: 40px;" onclick="nextStep(3)">Back</button>
                                        <button class="btn btn-primary-custom" style="width: auto; padding-left: 60px; padding-right: 60px;" id="signSubmitBtn" onclick="nextStep(5)" disabled>Sign & Submit</button>
                                    </div>
                                </div>

                                <!-- Step 5 Content -->
                                <div id="step5-content" class="step-content text-center py-4">
                                    <div class="mb-4">
                        ...
                        <script>
                            ...
                            // Terms checkbox: enable/disable Sign & Submit button based on acceptance
                            const agreeTermsCheckbox = document.getElementById('agreeTerms');
                            const signSubmitBtn = document.getElementById('signSubmitBtn');
                            if (agreeTermsCheckbox && signSubmitBtn) {
                                agreeTermsCheckbox.addEventListener('change', function() {
                                    signSubmitBtn.disabled = !this.checked;
                                });
                            }
                            ...
                            function verifyGst() {
                                ...
                                .then(data => {
                                    if (data.success) {
                                        ...
                                        gstStatus.innerHTML = '<i class="fas fa-check-circle"></i> ' + (data.message || 'GST verified successfully!');
                                        ...
                                        gstStatus.innerHTML = '<i class="fas fa-times-circle"></i> ' + (data.message || 'GST verification failed.');
                                        gstStatus.style.display = 'block';
                            ...
                            function verifyAadhar() {
                                ...
                                .then(data => {
                                    if (data.success) {
                                        ...
                                        aadharStatus.innerHTML = '<i class="fas fa-check-circle"></i> ' + (data.message || 'Aadhar verified successfully!');
                                        ...
                                        aadharStatus.innerHTML = '<i class="fas fa-times-circle"></i> ' + (data.message || 'Aadhar verification failed.');
                                        aadharStatus.style.display = 'block';
                            ...
                            function nextStep(stepNumber) {
                                ...
                                if (stepNumber === 2) {
                                    ...
                                    // Save business details (now in step 3)
                                    ...
                                    // Save terms acceptance (now in step 4)
                            ...
                            function submitKYC() {
                                // Show loading state
                                const submitBtn = document.querySelector('#step5-content button');
                                if (submitBtn) {
                                ...
                                .then(data => {
                                    if (data.success) {
                                        ...
                                        const messageDiv = document.querySelector('#step5-content p.text-muted');
                                        if (messageDiv) {
