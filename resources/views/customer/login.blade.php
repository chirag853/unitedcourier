@include('website_include.header')
    ...
    <script>
        ...
        function checkPhoneNumber() {
            ...
            getOtpBtn.innerHTML = '<i class="fas fa-circle-notch fa-spin"></i>';
            getOtpBtn.disabled = true;
            ...
            .then(data => {
                if (data.success) {
                    ...
                    phoneStatus.innerHTML = '<i class="fas fa-check-circle"></i> OTP sent successfully!';
                    ...
                    phoneStatus.innerHTML = '<i class="fas fa-times-circle"></i> ' + data.message;
                    phoneStatus.className = 'otp-sent-text text-danger';
                    phoneStatus.style.display = 'block';
