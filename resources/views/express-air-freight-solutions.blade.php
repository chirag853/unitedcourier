...
@php
    $statsTitle = $statsContent->isNotEmpty() && isset($statsContent->first()->content['title']) ? $statsContent->first()->content['title'] : 'Trusted by over <span class="gradient-text">50,000 Businesses</span> for daily logistics';
@endphp
    ...
    <div class="container">
        ...
        <div class="stats-wrapper">
            <div class="stats-container">
                ...
                @php
                    $statData = $stat->content;
                @endphp
                <div class="stat-card">
                    <div class="stat-number-wrapper">
                        <span class="stat-number" data-target="{{ $statData['value'] ?? 0 }}">0</span>{{ $statData['suffix'] ?? '' }}
                    </div>
                    <p class="stat-label">{{ $statData['label'] ?? $statData['title'] ?? '' }}</p>
                </div>
                @empty
                <!-- Card 1 -->
                <div class="stat-card">
        ...
        <div class="row g-4">
            <div class="col-lg-4">
                <div class="faq-illustration">
                    <img src="{{ $faqSidebarImage }}" alt="Help"
                    ...
                    <div class="moving-gradient-bg contact-box">
                        ...
                        <button style="background-color: #fff; color: #2563eb;" class="btn btn-contact">{{ $faqContactButtonText }}</button>
                    </div>
                </div>
            </div>
