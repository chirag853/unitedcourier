...
<head>
    ...
    <title>Change Refund & Cancellation Policy | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>
...
<body>
    ...
    document.getElementById('editForm').addEventListener('submit', function(e) {
        ...
        fetch(`/admin/update-refund-and-cancellation-policy-content/${id}`, {
            method: 'POST',
            body: formData,
            headers: {
    ...
    function deleteContent(id) {
        if (confirm('Are you sure you want to delete this content?')) {
            fetch(`/admin/delete-refund-and-cancellation-policy-content/${id}`, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
                }
