...
<head>
    ...
    <title>Change Blog | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>
        ...
        <div class="page-wrapper">
            ...
            <div class="content pb-0">
                ...
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Change Blog</h4>
                    </div>
                    <div class="gap-2 d-flex align-items-center flex-wrap">
                        <a href="{{ route('admin.create-blog') }}" class="btn btn-primary"><i
                                class="ti ti-plus me-1"></i> Add New Blog</a>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Blog Posts Management</h5>
                                <p class="card-text">View and Edit all blog posts</p>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img src="{{ asset($blog->master_image) }}" alt="{{ $blog->blog_title }}"
                                                ...
                                                <td>
                                                    <div class="table-actions">
                                                        <a href="{{ url('/admin/edit-blog/' . $blog->id) }}" class="btn btn-sm btn-primary action-btn">
