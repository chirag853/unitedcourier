...
<head>
    ...
    <title>Edit Track Order Page Content | CRMS</title>
...
<body>
            ...
            <div class="content pb-0">
                ...
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    ...
                    <div class="gap-2 d-flex align-items-center flex-wrap">
                        <a href="{{ route('admin.change-track-order') }}" class="btn btn-outline-secondary">
                            <i class="ti ti-arrow-left me-1"></i> Back to Track Order
                        </a>
                    </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="link" name="link"
                                                value="{{ old('link', $trackOrder->link) }}"
                                    ...
                                    <div class="card-body">
                                        ...
                                        @else
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="file" class="form-control" id="trackOrderImageFile"
                                                    name="image" accept="image/*"
                                                    onchange="previewImage(this, 'trackOrderImagePreview')">
                                                <div id="trackOrderImagePreview" class="mt-2"></div>
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="sort_order" name="sort_order"
                                            value="{{ old('sort_order', $trackOrder->sort_order ?? 0) }}"
    ...
    document.getElementById('trackOrderForm').addEventListener('submit', function(e) {
        ...
        let url = trackOrderId ? `/admin/update-track-order/${trackOrderId}` : '/admin/store-track-order';
