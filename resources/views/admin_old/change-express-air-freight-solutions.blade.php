...
<head>
    ...
    <title>Change Express Air Freight Solutions | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>
...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="content pb-0">
                ...
                <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                    <div>
                        <h4 class="mb-1">Change Express Air Freight Solutions</h4>
                    </div>
                ...
                <!-- Express Air Freight Solutions Content Table -->
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Express Air Freight Solutions Content Management</h5>
                                <p class="card-text">View and Edit all Express Air Freight Solutions page content sections</p>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="expressAirContentTable">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Section</th>
                                        ...
                                        <tbody>
                                            @forelse($expressAirContent as $content)
                                                @php
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="7" class="text-center py-4">
                                                        <p class="text-muted">No express air freight solutions content found. The page is empty.</p>
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="editModalLabel">Edit Express Air Freight Solutions Content</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="editForm" method="POST" action="{{ route('admin.store-express-air-freight-solutions-content') }}" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="heroFields" style="display:none;">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="heroBadgeText" name="content[badge_text]" placeholder="Express Air Freight Solutions">
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div id="testimonialsFields" style="display:none;">
                                    <div class="mb-3">
                                        <label for="testimonialName" class="form-label">Customer Name</label>
                                        <input type="text" class="form-control" id="testimonialName" name="content[name]" placeholder="John Doe">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="testimonialRating" name="content[rating]" min="1" max="5" placeholder="5">
                                    </div>
                                    <div class="mb-3">
                                        <label for="testimonialText" class="form-label">Testimonial Text</label>
                                        <textarea class="form-control" id="testimonialText" name="content[text]" rows="3" placeholder="Testimonial content..."></textarea>
                                    </div>
                                </div>
    ...
    $(document).ready( function () {
        $('#expressAirContentTable').DataTable();
    } );

    function editContent(button, id, section, itemKey, sortOrder, isActive) {
        const content = JSON.parse(button.dataset.content);
        const form = document.getElementById('editForm');
        form.action = '{{ route('admin.update-express-air-freight-solutions-content', ['id' => '__ID__']) }}'.replace('__ID__', id);
        ...
        switch(section) {
            ...
            case 'features':
                ...
                document.getElementById('featureIcon').value = content.icon_class || '';
            ...
            case 'faq_header':
                ...
                document.getElementById('faqHeaderBadge').value = content.badge_text || '';
    ...
    function openCreateModal() {
        const form = document.getElementById('editForm');
        form.action = '{{ route('admin.store-express-air-freight-solutions-content') }}';
    ...
    document.getElementById('editForm').addEventListener('submit', function(e) {
        ...
        let url = id ? `/admin/update-express-air-freight-solutions-content/${id}` : '/admin/store-express-air-freight-solutions-content';
    ...
    function getSectionFieldIds() {
        return ['heroFields','statsFields','featuresFields','featuresHeaderFields','overviewFields','testimonialsHeaderFields','testimonialsFields','faqFields','faqHeaderFields'];
    }
    ...
    function deleteContent(id) {
        if (confirm('Are you sure you want to delete this content?')) {
            fetch(`/admin/delete-express-air-freight-solutions-content/${id}`, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
                }
