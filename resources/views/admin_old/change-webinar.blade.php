...
<head>
    ...
    <title>Change Webinar | CRMS - Advanced Bootstrap 5 Admin Template</title>
        ...
        if (confirm('Are you sure you want to delete this webinar content?')) {
            fetch(`/admin/delete-webinar/${id}`, {
                ...
                .catch(error => {
                    ...
                    alert('An error occurred while deleting webinar content.');
                });
        }
    }
    </script>
