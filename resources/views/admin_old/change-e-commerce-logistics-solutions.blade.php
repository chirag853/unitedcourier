...
<head>
    ...
    <title>Change E-Commerce Logistics Solutions | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>
...
<body>
    ...
    document.getElementById('editForm').addEventListener('submit', function(e) {
        ...
        let url = id ? `/admin/update-e-commerce-logistics-solutions-content/${id}` : '/admin/store-e-commerce-logistics-solutions-content';
    ...
    function deleteContent(id) {
        if (confirm('Are you sure you want to delete this content?')) {
            fetch(`/admin/delete-e-commerce-logistics-solutions-content/${id}`, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
                }
