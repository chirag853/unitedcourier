...
<head>
    ...
    <title>Change Service Page | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>
...
<body>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="table-actions">
                                                            <button type="button" class="btn btn-sm btn-primary action-btn" data-bs-toggle="modal" data-bs-target="#editModal" onclick="editContent({{ $content->id }}, '{{ $content->section }}', '{{ $content->item_key }}', '{{ addslashes(json_encode($contentData)) }}', {{ $content->sort_order }}, {{ $content->is_active ? 1 : 0 }})">
    ...
    function editContent(id, section, itemKey, contentJson, sortOrder, isActive) {
    ...
    document.getElementById('editForm').addEventListener('submit', function(e) {
        ...
        fetch(`/admin/update-service-content/${id}`, {
            method: 'POST',
            body: formData,
            headers: {
    ...
    function deleteContent(id) {
        if (confirm('Are you sure you want to delete this content?')) {
            fetch(`/admin/delete-service-content/${id}`, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
                }
