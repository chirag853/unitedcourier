...
<body>
    ...
    function editContent(id, sectionType, title, subtitle, description, image, iconSvg, status) {
        ...
        document.getElementById('editIconSvg').value = iconSvg;
    ...
    document.getElementById('editForm').addEventListener('submit', function(e) {
        ...
        fetch(`/admin/update-about-content/${id}`, {
            method: 'POST',
            body: formData,
            headers: {
    ...
    function deleteContent(id) {
        if (confirm('Are you sure you want to delete this content?')) {
            fetch(`/admin/delete-about-content/${id}`, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
                }
