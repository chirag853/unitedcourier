...
<head>
    ...
    <title>Change Contact Page | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>
...
<body>
    ...
    document.getElementById('editForm').addEventListener('submit', function(e) {
        ...
        fetch(`/admin/update-contact-page-content/${id}`, {
            method: 'POST',
            body: formData,
            headers: {
    ...
    function deleteContent(id) {
        if (confirm('Are you sure you want to delete this content?')) {
            fetch(`/admin/delete-contact-page-content/${id}`, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
                }
