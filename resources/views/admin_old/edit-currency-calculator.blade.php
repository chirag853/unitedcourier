...
<head>
    ...
    <title>Edit Currency Calculator Page Content | CRMS</title>
...
<body>
    ...
    document.getElementById('currencyCalculatorForm').addEventListener('submit', function(e) {
        ...
        let url = currencyCalculatorId ? `/admin/update-currency-calculator/${currencyCalculatorId}` : '/admin/store-currency-calculator';
        ...
        fetch(url, {
            ...
            .then(data => {
                if (data.success) {
                    alert(data.message);
                    window.location.href = '{{ route("admin.change-currency-calculator") }}';
                } else {
