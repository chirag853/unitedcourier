    ...
    <div class="container">
        <div class="row align-items-center g-4 g-lg-5">
            ...
            <div class="col-md-6 text-md-start text-center animate__animated animate__fadeInLeft">
                ...
                <a href="{{ $heroData->data['button_url'] ?? '#calcualte_section' }}" class="book-btn-service"><i
                        class="fas fa-calculator"></i> &nbsp; {{ $heroData->data_button_text ?? 'Calculate Now' }}</a>
...
<section id="calcualte_section" class="py-5 bg-white">
    <div class="container">
        <div class="row form-shadow ">
            <div class="col-md-8">
                <div class="mx-auto">
                                    ...
                                    @if ($calculator && isset($calculator->data['divisor_options']))
                                        @foreach ($calculator->data['divisor_options'] as $option)
                                            <label class="m-1"
                                                ...
                                                <input type="radio" name="divisor" value="{{ $option['value'] }}">
                                                {{ $option['text'] }}
                                            </label>
                                        @endforeach
                                    @else
                    ...
                    <p
                        style="background:#f3f3f3; padding: 10px 15px; margin-top: 20px; font-weight: 600; border-radius: 20px; width: fit-content;">
                        Formula:(L × W × H) ÷ 5000</p>
                ...
                <div class="col-md-4">
                    <div class="feature-card">
                        <div class="feature-icon fi-blue"><i
                                class="{{ $feature->data_icon ?? 'fa-solid fa-ruler' }}"></i></div>
            ...
            <div class="col-lg-8 text-center">
                <div class="google-badge">
                    <a href="{{ $testimonialsHeader->data['badge_url'] ?? '#' }}">
                        <img src="{{ asset($testimonialsHeader->data['badge_image'] ?? 'public/website_images/google-review.png') }}"
                            alt="{{ $testimonialsHeader->data['badge_alt'] ?? 'Google' }}">
                    </a>
                </div>
                <h2 class="about-title">{{ $testimonialsHeader->data_title ?? 'Trusted by the Brands You Trust' }}
                </h2>
