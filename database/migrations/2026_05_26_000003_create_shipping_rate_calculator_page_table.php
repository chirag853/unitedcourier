...
return new class extends Migration
{
    ...
    {
        Schema::create('shipping_rate_calculator_page', function (Blueprint $table) {
            $table->id();
        ...
        // Insert seed data for the shipping rate calculator page
        // Hero section
        DB::table('shipping_rate_calculator_page')->insert([
            [
                'section_type' => 'hero',
                'title' => 'Shipping <span class="moving-gradient-text">Rate Calculator</span>',
                'description' => 'Get accurate, all-inclusive rates in seconds — no hidden charges, no guesswork.',
                'image' => 'website_images/shipping-rate-calculator.webp',
                'page_badge_text' => 'Free Tool · Instant Results',
                'display_order' => 0,
                'status' => true,
                'created_at' => now(),
                'updated_at' => now(),
        ...
        $features = [
            [
                ...
                'description' => 'Add your pickup pincode and shipment information to begin calculating your courier charges across India and international destinations.',
                'page_icon_class' => 'fa-solid fa-location-dot',
                'display_order' => 1,
                'status' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                ...
                'description' => 'Choose the delivery country and shipment weight to get accurate international shipping rates with express delivery options.',
                'page_icon_class' => 'fa-solid fa-earth-asia',
                'display_order' => 2,
                'status' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                'section_type' => 'features',
                'title' => 'Get Shipping Rate Instantly',
                'description' => 'View estimated courier pricing instantly with transparent charges, faster transit options, and no hidden costs at checkout.',
                'page_icon_class' => 'fa-solid fa-money-bill-wave',
                'display_order' => 3,
                'status' => true,
                'created_at' => now(),
                'updated_at' => now(),
        ...
        DB::table('shipping_rate_calculator_page')->insert($features);
        ...
        DB::table('shipping_rate_calculator_page')->insert($faqItems);
    ...
    {
        Schema::dropIfExists('shipping_rate_calculator_page');
    }
};