...
class EcommerceLogisticsSolutionsPage extends Model
{
    use HasFactory;

    protected $table = 'ecommerce_logistics_solutions_page';
    ...
    public function getContentAttribute($value)
    {
        ...
        // e.g. admin JS reads content.icon but normalized column is icon_svg
